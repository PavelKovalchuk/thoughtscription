 ...
 * Class OptionPages
 *
 * is a PHP class used to build option pages for WordPress.
 * You don't need to deal with all the hooks and functions.
 * What you pass to this class is an associative array with your option page's structure and fields.
 *
 * https://github.com/jeremyHixon/rational-option-page
 */
