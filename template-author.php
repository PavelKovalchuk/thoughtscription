                ...
                <div class="col-lg-12">
                    ...
                    <div class="author_top_image_outer">
                        ...
                        <div class="author_top_text_outer">
                            <h2 class="author_top_text_question wow slideInLeft" data-wow-duration="1s">

		                    <?php echo $data['page_hero_text']; ?>

                            </h2>

                            <h1 class="author_top_text_answer wow slideInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-md-6 author-left">
                                    ...
                                    <div class="author_profile_img_outer">
                                        ...
                                        <p class="author_position wow slideInUp" data-wow-duration="1s">
		                                    <?php echo $data['author_position']; ?>
                                        </p>

                                        <h3 class="author_name author_name_mobile wow slideInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                                    ...
                                    <div class="author_blog_aim">
                                        ...
                                        <h3 class="author_blog_aim_title wow slideInUp" data-wow-duration="1s">
	                                        <?php echo $data['ts_title']; ?>

                                        </h3>

                                        <p class="author_blog_aim_text wow slideInUp" data-wow-duration="1s">
		                                    <?php echo $data['ts_text']; ?>
                                        </p>

                                        <blockquote class="author_blog_aim_quote wow slideInUp" data-wow-duration="1s">
                                ...
                                <div class="col-md-6 author-right">
                                    ...
                                    <div class="data_shifted_left">
                                        ...
                                        <h3 class="author_name author_name_desktop wow slideInUp" data-wow-duration="1s" data-wow-delay="0.5s">
		                                    <?php echo $data['author_name']; ?>
		                                    <?php echo $data['author_surname']; ?>
                                        </h3>

                                        <div class="author_speaker_img_outer wow slideInUp" data-wow-duration="1s">
                                            <img src="<?php echo $data['author_photo_2']['url']; ?>" class="author_content_image author_speaker" alt="<?php echo $data['author_photo_2']['alt']; ?>" />
                                        </div>

                                        <p class="position_description wow slideInUp" data-wow-duration="1s">
	                                        <?php echo $data['author_position_description']; ?>
                                        </p>

                                        <div class="author_place_img_outer wow slideInUp" data-wow-duration="1s">
                                        ...
                                        <div class="col-lg-12 col-xl-6 marketing_left">
                                            ...
                                            <div class="row marketing_title_row">
                                                <div class="col-md-12">
                                                    ...
                                                    <h3 class="marketing_title  wow slideInUp" data-wow-duration="1s">
								                        <?php echo $data['marketing_blog_title']; ?>
                                                    </h3>

                                                    <h4 class="marketing_title_second  wow slideInUp" data-wow-duration="1s">
								                        <?php echo $data['marketing_blog_title_second']; ?>
                                                    </h4>

                                                    <p class="marketing_title_description  wow slideInUp" data-wow-duration="1s">
                                        ...
                                        <div class="col-lg-12 col-xl-6  marketing_right">
                                            ...
                                            <div class="row marketing_text_row">
                                                <div class="col-md-12">
                                                    ...
                                                    <p class="marketing_text_1  wow slideInUp" data-wow-duration="1s">
								                        <?php echo $data['marketing_blog_text_1']; ?>
                                                    </p>

                                                    <p class="marketing_text_2  wow slideInUp" data-wow-duration="1s">
								                        <?php echo $data['marketing_blog_text_2']; ?>
                                                    </p>

                                                    <p class="marketing_text_3  wow slideInUp" data-wow-duration="1s">
